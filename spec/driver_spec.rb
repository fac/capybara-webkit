...
describe Capybara::Webkit::Driver do
  ...
  context "mouse app" do
    ...
    it "fires a change on select" do
      ...
      driver.find_xpath("//select[@id='change_select'][@class='triggered']").should_not be_empty
    end
    ...
    it "fires a change on select when using an optgroup" do
      ...
      option.select_option
      select.value.should eq "2"
      driver.find_xpath("//select[@id='change_select_in_optgroup'][@class='triggered']").should_not be_empty
    end
